...
public final class NotableConstants {           // As in all these constants are used to 
    ...
    public static final class MAC {             // Master arm constants
        ...
        public static final double MASTER_ARM_CANCODER_RANGE = AbsoluteSensorDiscontinuityPoint;
    ...
    public static final class IAC {             // Inner arm constants
        ...
        public static final double INNER_ARM_CANCODER_RANGE = AbsoluteSensorDiscontinuityPoint;
 ...
 ********************************************************************/
    ...
    public static final class SC {             // Shooter constants
        ...
        public static final SparkMaxConfig.IdleMode AIM_MOTOR_NEUTRAL_MODE = SparkMaxConfig.IdleMode.kBrake;
